...
func TestParser(t *testing.T) {
	valid := func(in, normalized, expectedDump string) {
		...
		require.Equal(t, normalized, v.String(), "printing of '%s'", in)
		dump := string(v.major) + ","
		dump += string(v.minor) + ","
		dump += string(v.patch)
	...
	valid("14", "14.0.0", "14,0,0")
	valid("123456789123456789123456789", "123456789123456789123456789.0.0", "123456789123456789123456789,0,0")
	invalid("12ab")
	invalid("01")
	invalid("0ab")
	invalid(".1.1")
	invalid("1-")
	valid("1-0", "1.0.0-0", "1,0,0,N0")
	valid("1-pre", "1.0.0-pre", "1,0,0,pre")
	valid("1-pre.a", "1.0.0-pre.a", "1,0,0,pre,a")
	valid("1-pre.a.0", "1.0.0-pre.a.0", "1,0,0,pre,a,N0")
	valid("1-pre.0.a", "1.0.0-pre.0.a", "1,0,0,pre,N0,a")
	valid("1-pre.a.10", "1.0.0-pre.a.10", "1,0,0,pre,a,N10")
	invalid("1-pre.a.01")
	invalid("1-pre.a..1")
	invalid("1-pre.a.01.1")
	invalid("1-pre.a.01*.1")
	valid("1+build3", "1.0.0+build3", "1,0,0;build3")
	invalid("1+build3+build2")
	valid("1+build3.123.001", "1.0.0+build3.123.001", "1,0,0;build3;123;001")
	invalid("1+build3.123..001")
	invalid("1+build3.123*.001")
	valid("1-0+build3", "1.0.0-0+build3", "1,0,0,N0;build3")
	valid("1-pre+build3", "1.0.0-pre+build3", "1,0,0,pre;build3")
	valid("1-pre.a+build3", "1.0.0-pre.a+build3", "1,0,0,pre,a;build3")
	valid("1-pre.a.10+build3", "1.0.0-pre.a.10+build3", "1,0,0,pre,a,N10;build3")
	invalid("1-pre.a.01+build3")
	invalid("1-pre.a..1+build3")
	invalid("1-pre.a.01.1+build3")
	invalid("1-pre.a.01*.1+build3")
	valid("1-0+build3.123.001", "1.0.0-0+build3.123.001", "1,0,0,N0;build3;123;001")
	valid("1-pre+build3.123.001", "1.0.0-pre+build3.123.001", "1,0,0,pre;build3;123;001")
	valid("1-pre.a+build3.123.001", "1.0.0-pre.a+build3.123.001", "1,0,0,pre,a;build3;123;001")
	valid("1-pre.a.0+build3.123.001", "1.0.0-pre.a.0+build3.123.001", "1,0,0,pre,a,N0;build3;123;001")
	valid("1-pre.0.a+build3.123.001", "1.0.0-pre.0.a+build3.123.001", "1,0,0,pre,N0,a;build3;123;001")
	valid("1-pre.a.10+build3.123.001", "1.0.0-pre.a.10+build3.123.001", "1,0,0,pre,a,N10;build3;123;001")
	...
	invalid("1.a")
	invalid("1..2")
	valid("1.2", "1.2.0", "1,2,0")
	valid("1.0", "1.0.0", "1,0,0")
	invalid("1.02")
	invalid("1.0ab")
	invalid("1.12ab")
	valid("1.123456789123456789123456789", "1.123456789123456789123456789.0", "1,123456789123456789123456789,0")
	invalid("1.2-")
	valid("1.2-0", "1.2.0-0", "1,2,0,N0")
	valid("1.2-pre", "1.2.0-pre", "1,2,0,pre")
	valid("1.2-pre.a", "1.2.0-pre.a", "1,2,0,pre,a")
	valid("1.2-pre.a.0", "1.2.0-pre.a.0", "1,2,0,pre,a,N0")
	valid("1.2-pre.0.a", "1.2.0-pre.0.a", "1,2,0,pre,N0,a")
	valid("1.2-pre.a.10", "1.2.0-pre.a.10", "1,2,0,pre,a,N10")
	valid("1.2-pre.a.10", "1.2.0-pre.a.10", "1,2,0,pre,a,N10")
	...
	valid("1.2+build3", "1.2.0+build3", "1,2,0;build3")
	valid("1.2-0+build3", "1.2.0-0+build3", "1,2,0,N0;build3")
	invalid("1.2+build3+build2")
	valid("1.2+build3.123.001", "1.2.0+build3.123.001", "1,2,0;build3;123;001")
	invalid("1.2+build3.123..001")
	invalid("1.2+build3.123*.001")
	valid("1.2-pre+build3", "1.2.0-pre+build3", "1,2,0,pre;build3")
	valid("1.2-pre.a.0+build3", "1.2.0-pre.a.0+build3", "1,2,0,pre,a,N0;build3")
	valid("1.2-pre.0.a+build3", "1.2.0-pre.0.a+build3", "1,2,0,pre,N0,a;build3")
	valid("1.2-pre.a.10+build3", "1.2.0-pre.a.10+build3", "1,2,0,pre,a,N10;build3")
	valid("1.2-pre.a+build3", "1.2.0-pre.a+build3", "1,2,0,pre,a;build3")
	valid("1.2-pre.a.10+build3", "1.2.0-pre.a.10+build3", "1,2,0,pre,a,N10;build3")
	invalid("1.2-pre.a.01+build3")
	invalid("1.2-pre.a..1+build3")
	invalid("1.2-pre.a.01.1+build3")
	invalid("1.2-pre.a.01*.1+build3")
	valid("1.2-0+build3.123.001", "1.2.0-0+build3.123.001", "1,2,0,N0;build3;123;001")
	valid("1.2-pre+build3.123.001", "1.2.0-pre+build3.123.001", "1,2,0,pre;build3;123;001")
	valid("1.2-pre.a+build3.123.001", "1.2.0-pre.a+build3.123.001", "1,2,0,pre,a;build3;123;001")
	valid("1.2-pre.a.0+build3.123.001", "1.2.0-pre.a.0+build3.123.001", "1,2,0,pre,a,N0;build3;123;001")
	valid("1.2-pre.0.a+build3.123.001", "1.2.0-pre.0.a+build3.123.001", "1,2,0,pre,N0,a;build3;123;001")
	valid("1.2-pre.a.10+build3.123.001", "1.2.0-pre.a.10+build3.123.001", "1,2,0,pre,a,N10;build3;123;001")
	valid("1.2-pre.a.10+build3.123.001", "1.2.0-pre.a.10+build3.123.001", "1,2,0,pre,a,N10;build3;123;001")
